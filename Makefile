...
#   	install -Dm644 acer-battery-control.rules ${DESTDIR}/usr/share/polkit-1/rules.d/acer-battery-control.rules
...
#   	install -Dm644 acer-care-center_256x256.png ${DESTDIR}/usr/share/icons/hicolor/256x256/apps/acer-battery-control.png
#   	install -Dm644 acer-care-center_48x48.png ${DESTDIR}/usr/share/icons/hicolor/48x48/apps/acer-battery-control.png
